...
export const SEL = {
  ...
  // Диалоги после входа (мультиязычно — «Зберегти дані входу?»/«Увімкнути сповіщення?»/cookie).
  // Кнопка ЗАКРЫТИЯ (не подтверждения): укр. «Не зараз/Скасувати/Пропустити», рус., англ., исп., др.
  // Раньше был только рус./англ. → на украинском UI (частый кейс) всплывашки НЕ закрывались и
  // перекрывали иконку уведомлений → приём заявок падал «панель не открылась».
  notNowButtons: [
    'Not Now', 'Not now', 'Dismiss', 'Skip', 'Maybe Later', 'Later',
    'Не сейчас', 'Позже', 'Отмена', 'Пропустить', 'Закрыть',
    'Не зараз', 'Скасувати', 'Пропустити', 'Пізніше', 'Закрити',
    'Cancel', 'Ahora no', 'Cancelar', 'Nanti Saja', 'Lain kali', 'Daha Sonra', 'Nie teraz',
  ],
