...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Кука выставлена сервером — после входа возвращаем на САЙТ (не в приложение); в функционал
      // пользователь войдёт кнопкой «Перейти к функционалу» на сайте.
      router.push('/lp')
      router.refresh()
    } catch {
      ...
      <div className="w-full max-w-[400px] animate-scale-in">
        ...
        <div className="card p-7 space-y-3.5">
          ...
          <p className="text-center text-[13px] text-subt pt-1">
            Нет аккаунта?{' '}
            <a href="/register" className="text-brand hover:underline font-medium">Зарегистрироваться</a>
          </p>
        </div>
