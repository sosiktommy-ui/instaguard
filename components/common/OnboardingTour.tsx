...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    text: 'Лимиты, режим «без прокси» и повтор обучения. Загляни сюда, если что-то не запускается.',
  },
  {
    route: '/triggers',
    title: 'Готово! 🚀',
    text: 'Порядок такой: подключи аккаунт → (по желанию прокси) → создай кампанию. Позвать меня снова можно в «Настройках». Удачи!',
  },
]
